...
export interface AppInfoPanelProps { id: string, appInfo: AppInfo, model: Model, onClosePanel: any }
export interface AppInfoPanelState {
    nluDefault: string;
...
export default class AppInfoPanel extends React.Component<AppInfoPanelProps, AppInfoPanelState> {
    ...
    render() {
        ...
        return  <Draggable handle=".handle">
                    <div className="app-panel well" id="appInfoPanel" ref="appInfoPanel">
                    <Titlebar
                        draggable={true}
                    ...
                    <h4 className="pull-left handle" style={{marginBottom:20}}>App Info</h4>
